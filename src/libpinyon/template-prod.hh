...
namespace detail
{
    ...
    auto cartesian_product_per_template_helper(TypePack<ParamTs...>, ArgTuple &&arg_tuple) -> std::tuple<Template<ParamTs>...>
    {
    ...
    auto cartesian_product_per_param_helper(TemplatePack<Templates...>, ArgTuple &&arg_tuple) -> std::tuple<Templates<ParamT>...>
    {
    ...
    auto type_list_cart_prod_helper (TypePack<TemplateParams...>) -> std::tuple<Template<TemplateParams>...>
    {
