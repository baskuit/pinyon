...
template <CONCEPT(IsSingleModelTypes, Types), bool debug = false>
struct AlphaBetaIter : Types
{
    ...
    public:
            ...
            Real beta) const
        {
            ...
            if constexpr (debug)
            {
                std::cout << "AB ITER; depth: " << max_depth << std::endl;
                matrix_node->chance_data_matrix.print();
                std::cout << std::endl;
            }
