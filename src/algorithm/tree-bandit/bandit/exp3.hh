...
// Constant Sum State Specialization

// template <class Model, template <class _Model, class _BanditAlgorithm, class Outcome> 
//     class _TreeBandit>
// class Exp3<Model, _TreeBandit, typename std::enable_if<Model::Types::State::IS_CONSTANT_SUM>::type>
//     : public _TreeBandit<Model, Exp3<Model, _TreeBandit>, ChoicesOutcome<Model>>
// {
...
//         const typename Types::Real den = 1 / (stats.total_visits + (stats.total_visits == 0));
//         row_value = stats.row_value_total * den;
//         col_value = Model::Types::State::PAYOFF_SUM - row_value;
//     }
...
//         typename Types::Outcome &outcome)
//     {
//         matrix_node->stats.row_value_total += outcome.value;
//         matrix_node->stats.visits += 1;
//         matrix_node->stats.row_visits[outcome.row_idx] += 1;
//         matrix_node->stats.col_visits[outcome.col_idx] += 1;
