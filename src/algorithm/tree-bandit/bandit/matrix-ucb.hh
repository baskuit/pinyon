...
template <class Model, template <class _Model, class _BanditAlgorithm, class _Outcome> class _TreeBandit = TreeBandit, typename = void>
...
template <class Model, template <class _Model, class _BanditAlgorithm, class _Outcome>
                       class _TreeBandit>
class MatrixUCB<Model, _TreeBandit, typename std::enable_if<Model::Types::State::IS_CONSTANT_SUM>::type>
    : public _TreeBandit<Model, MatrixUCB<Model, _TreeBandit>, ChoicesOutcome<Model>>
{
public:
    struct MatrixStats;
    struct ChanceStats;
