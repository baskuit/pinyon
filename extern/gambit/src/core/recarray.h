...
namespace Gambit
{
  ...
  template <class T>
  bool RectArray<T>::CheckRow(int row) const
  {
    return (minrow <= row && row <= maxrow);
  }

  template <class T>
  bool RectArray<T>::CheckRow(const Array<T> &v) const
  {
    return (v.First() == mincol && v.Last() == maxcol);
  }

  template <class T>
  bool RectArray<T>::CheckColumn(int col) const
  {
    return (mincol <= col && col <= maxcol);
  }

  template <class T>
  bool RectArray<T>::CheckColumn(const Array<T> &v) const
  {
    return (v.First() == minrow && v.Last() == maxrow);
  }

  template <class T>
  bool RectArray<T>::Check(int row, int col) const
  {
  ...
  template <class T>
  RectArray<T>::RectArray(unsigned int rows,
                          unsigned int cols)
  ...
  template <class T>
  int RectArray<T>::NumRows() const
  {
    return maxrow - minrow + 1;
  }

  template <class T>
  int RectArray<T>::NumColumns() const
  {
    return maxcol - mincol + 1;
  }

  template <class T>
  int RectArray<T>::MinRow() const { return minrow; }
  template <class T>
  int RectArray<T>::MaxRow() const { return maxrow; }
  template <class T>
  int RectArray<T>::MinCol() const { return mincol; }
  template <class T>
  int RectArray<T>::MaxCol() const { return maxcol; }

  template <class T>
  T &RectArray<T>::operator()(int r, int c)
  {
    if (!Check(r, c))
  ...
  template <class T>
  const T &RectArray<T>::operator()(int r, int c) const
  {
    if (!Check(r, c))
      throw IndexException();
  ...
  template <class T>
  void RectArray<T>::RotateUp(int lo, int hi)
  {
  ...
  template <class T>
  void RectArray<T>::RotateDown(int lo, int hi)
  {
    if (lo < minrow || hi < lo || maxrow < hi)
      throw IndexException();
  ...
  template <class T>
  void RectArray<T>::RotateLeft(int lo, int hi)
  {
  ...
  template <class T>
  void RectArray<T>::RotateRight(int lo, int hi)
  {
    if (lo < mincol || hi < lo || maxcol < hi)
      throw IndexException();
  ...
  template <class T>
  void RectArray<T>::SwitchRow(int row, Array<T> &v)
  {
    if (!CheckRow(row))
      throw IndexException();
    if (!CheckRow(v))
  ...
  template <class T>
  void RectArray<T>::SwitchRows(int i, int j)
  {
  ...
  template <class T>
  void RectArray<T>::GetRow(int row, Array<T> &v) const
  {
    if (!CheckRow(row))
      throw IndexException();
    if (!CheckRow(v))
  ...
  template <class T>
  void RectArray<T>::SetRow(int row, const Array<T> &v)
  {
    if (!CheckRow(row))
      throw IndexException();
    if (!CheckRow(v))
  ...
  template <class T>
  void RectArray<T>::SwitchColumn(int col, Array<T> &v)
  {
    if (!CheckColumn(col))
      throw IndexException();
    if (!CheckColumn(v))
  ...
  template <class T>
  void RectArray<T>::SwitchColumns(int a, int b)
  {
  ...
  template <class T>
  void RectArray<T>::GetColumn(int col, Array<T> &v) const
  {
    if (!CheckColumn(col))
      throw IndexException();
    if (!CheckColumn(v))
  ...
  template <class T>
  void RectArray<T>::SetColumn(int col, const Array<T> &v)
  {
    if (!CheckColumn(col))
      throw IndexException();
    if (!CheckColumn(v))
  ...
  template <class T>
  RectArray<T> RectArray<T>::Transpose() const
  {
